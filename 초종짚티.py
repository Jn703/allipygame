...
승리문자 = font.render("승리!", True, (0, 0, 0), (0, 255, 0))
패배문자 = font.render("패배...", True, (0, 0, 0), (255, 0, 0))
무승부문자 = font.render("무승부!", True, (0, 0, 0), None)
        ...
        if event.type == pg.QUIT:
            ...
            if scissors_pos.collidepoint(pg.mouse.get_pos()):
                ...
                if random_computer == rock:
                    screen.blit(패배문자, (200, 150))
                elif random_computer == scissors:
                    screen.blit(무승부문자, (200, 150))
                else:
                    screen.blit(승리문자, (200, 150))
